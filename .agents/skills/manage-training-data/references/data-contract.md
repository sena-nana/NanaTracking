...
- First-party Stage A manifests pin the MediaPipe descriptor/bundle, ordered mapping, reviewed
  calibration and quality profile, approved aggregate overlay review, recipe, split plan, and
  materialized shard. Identity, session, device, and camera IDs are split-owned.
