...
For commercial core-16 candidate materialization, require the first-party multiview capture,
reviewed calibration/quality profile, pinned MediaPipe/OpenCV providers, aggregate overlay approval,
independent per-record human evidence, and identity/session/device/camera split ownership described
in `references/data-contract.md`. Aggregate approval must never promote unreviewed records.
